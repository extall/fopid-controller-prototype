...
MODEL                := rt_test
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_test_data.c rt_test_tgtconn.c
MAKEFILE             := rt_test.mk
...
#
MODELLIB                  := rt_testlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := rt_test_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/Aleksei/Documents/softdev/fopid-controller-prototype/Simulink_tests;C:/Users/Aleksei/Documents/softdev/fopid-controller-prototype/Simulink_tests/rt_test_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
